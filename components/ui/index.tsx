...
export function Logo({ size = 1, showWordmark = true }: { size?: number; showWordmark?: boolean }) {
  ...
  const h = 48 * size;
  return (
    <svg width={w} height={h} viewBox="0 0 216 48" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SafeBusinessSelling">
...
export const Icon = {
  Check: ({ size = 14, color = 'currentColor' }: { size?: number; color?: string }) => (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="20 6 9 17 4 12" />
    </svg>
  ),
  Star: ({ size = 12, color = 'currentColor', filled = true }: { size?: number; color?: string; filled?: boolean }) => (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill={filled ? color : 'none'} stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
    </svg>
  ),
  Arrow: ({ size = 14 }: { size?: number }) => (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  Dot: ({ size = 6, color = 'currentColor' }: { size?: number; color?: string }) => (
    <svg aria-hidden="true" focusable="false" width={size} height={size} viewBox="0 0 6 6">
